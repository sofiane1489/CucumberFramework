...
public class ExcelUtils {
    ...
    private final Logger LOG = LogManager.getLogger(ExcelUtils.class.getName());
...
//            }
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = currentDir + File.separator + "src" + File.separator + "test" + File.separator + "resources"+ File.separator + "data"+ File.separator + "testcases.xlsx";
        ExcelUtils excelReader = new ExcelUtils(path);
        String name="luma";
